...
public class FireMonsterTest {
    ...
    public void sleep_recordsTimeOfLastSleptInDatabase() {
        ...
        Timestamp savedFireMonsterSleeptime= FireMonster.find(testFireMonster.getId()).getLastSlept();
        Timestamp rightNow = new Timestamp(new Date().getTime());

        assertEquals(DateFormat.getDateTimeInstance().format(rightNow), DateFormat.getDateTimeInstance().format(savedFireMonsterSleeptime));
    }
